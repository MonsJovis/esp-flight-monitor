...
static const actype_lookup_t ACTYPES[] = {
    ...
    {"A30B", {"Airbus", "A300B", "Airbus A300B", "Großraumjet", AC_CAT_AIRLINER}},
    ...
    {"A342", {"Airbus", "A340-200", "Airbus A340-200", "Großraumjet", AC_CAT_AIRLINER}},
    {"A343", {"Airbus", "A340-300", "Airbus A340-300", "Großraumjet", AC_CAT_AIRLINER}},
    {"A345", {"Airbus", "A340-500", "Airbus A340-500", "Großraumjet", AC_CAT_AIRLINER}},
    ...
    {"AN24", {"Antonov", "An-24", "Antonov An-24", "Turboprop", AC_CAT_AIRLINER}},
    {"AN26", {"Antonov", "An-26", "Antonov An-26", "Turboprop", AC_CAT_AIRLINER}},
    ...
    {"B741", {"Boeing", "747-100", "Boeing 747-100", "Großraumjet", AC_CAT_AIRLINER}},
    {"B742", {"Boeing", "747-200", "Boeing 747-200", "Großraumjet", AC_CAT_AIRLINER}},
    {"B743", {"Boeing", "747-300", "Boeing 747-300", "Großraumjet", AC_CAT_AIRLINER}},
    ...
    {"BE10", {"Beechcraft", "King Air 100", "Beechcraft King Air 100", "Turboprop", AC_CAT_PRIVATE}},
    ...
    {"BE30", {"Beechcraft", "King Air 300", "Beechcraft King Air 300", "Turboprop", AC_CAT_PRIVATE}},
    ...
    {"BE99", {"Beechcraft", "99 Airliner", "Beechcraft 99 Airliner", "Turboprop", AC_CAT_AIRLINER}},
    ...
    {"C212", {"CASA", "C-212", "CASA C-212 Aviocar", "Turboprop", AC_CAT_AIRLINER}},
    ...
    {"C25M", {"Cessna", "Citation M2", "Cessna Citation M2", "Geschäftsreisejet", AC_CAT_PRIVATE}},
    ...
    {"C425", {"Cessna", "425", "Cessna 425 Conquest I", "Turboprop", AC_CAT_PRIVATE}},
    {"C441", {"Cessna", "441", "Cessna 441 Conquest II", "Turboprop", AC_CAT_PRIVATE}},
    ...
    {"C68A", {"Cessna", "Citation Latitude", "Cessna Citation Latitude", "Geschäftsreisejet", AC_CAT_PRIVATE}},
    {"C700", {"Cessna", "Citation Longitude", "Cessna Citation Longitude", "Geschäftsreisejet", AC_CAT_PRIVATE}},
    ...
    {"CL30", {"Bombardier", "Challenger 300", "Bombardier Challenger 300", "Geschäftsreisejet", AC_CAT_PRIVATE}},
    ...
    {"DHC6", {"De Havilland Canada", "DHC-6", "De Havilland Twin Otter", "Turboprop", AC_CAT_AIRLINER}},
    ...
    {"E110", {"Embraer", "EMB-110", "Embraer EMB-110 Bandeirante", "Turboprop", AC_CAT_AIRLINER}},
    ...
    {"E35L", {"Embraer", "Legacy 600", "Embraer Legacy 600", "Geschäftsreisejet", AC_CAT_PRIVATE}},
    {"E3TF", {"Boeing", "E-3 Sentry", "Boeing E-3 Sentry (AWACS)", "Militärflugzeug", AC_CAT_MILITARY}},
    {"E50P", {"Embraer", "Phenom 100", "Embraer Phenom 100", "Geschäftsreisejet", AC_CAT_PRIVATE}},
    ...
    {"F27", {"Fokker", "F27", "Fokker F27 Friendship", "Turboprop", AC_CAT_AIRLINER}},
    ...
    {"FA8X", {"Dassault", "Falcon 8X", "Dassault Falcon 8X", "Geschäftsreisejet", AC_CAT_PRIVATE}},
    {"FK9", {"FK-Lightplanes", "FK9", "FK-Lightplanes FK9", "Ultraleichtflugzeug", AC_CAT_PRIVATE}},
    {"G280", {"Gulfstream", "G280", "Gulfstream G280", "Geschäftsreisejet", AC_CAT_PRIVATE}},
    ...
    {"HDJT", {"Honda Aircraft", "HA-420", "HondaJet HA-420", "Geschäftsreisejet", AC_CAT_PRIVATE}},
    ...
    {"LJ31", {"Learjet", "Learjet 31", "Learjet 31", "Geschäftsreisejet", AC_CAT_PRIVATE}},
    ...
    {"LJ75", {"Learjet", "Learjet 75", "Learjet 75", "Geschäftsreisejet", AC_CAT_PRIVATE}},
    ...
    {"MA60", {"Xi'an", "MA60", "Xi'an MA60", "Turboprop", AC_CAT_AIRLINER}},
    ...
    {"MU2", {"Mitsubishi", "MU-2", "Mitsubishi MU-2", "Turboprop", AC_CAT_PRIVATE}},
    ...
    {"P46T", {"Piper", "PA-46", "Piper PA-46 Meridian", "Turboprop", AC_CAT_PRIVATE}},
    ...
    {"PAY1", {"Piper", "PA-31T", "Piper PA-31T Cheyenne I", "Turboprop", AC_CAT_PRIVATE}},
    {"PAY2", {"Piper", "PA-31T", "Piper PA-31T Cheyenne", "Turboprop", AC_CAT_PRIVATE}},
    {"PAY3", {"Piper", "PA-42", "Piper PA-42 Cheyenne III", "Turboprop", AC_CAT_PRIVATE}},
    ...
    {"PRM1", {"Beechcraft", "Premier I", "Beechcraft Premier I", "Geschäftsreisejet", AC_CAT_PRIVATE}},
    ...
    {"SF50", {"Cirrus", "SF50", "Cirrus Vision Jet", "Geschäftsreisejet", AC_CAT_PRIVATE}},
    ...
    {"SW4", {"Swearingen", "Metro", "Swearingen Metro", "Turboprop", AC_CAT_AIRLINER}},
